...
| US-06 | Aggiunta di una traccia a una playlist | Permette all'utente di aggiungere una traccia una playlist. |
| US-07 | Rimozione traccia da una playlist | Permette di rimuovere unua traccia da una playlist. |
